...
;define("shop/models/shops", ["exports", "ember-data"], function (_exports, _emberData) {
  "use strict";
...
;define("shop/routes/shops", ["exports"], function (_exports) {
  ...
  var _default = Ember.Route.extend({
    model(params) {
      return this.store.findAll('shops', params.id);
    }
...
;define("shop/templates/shops", ["exports"], function (_exports) {
  ...
  var _default = Ember.HTMLBars.template({
    "id": "8vzQZD4e",
    "block": "{\"symbols\":[\"shop\"],\"statements\":[[7,\"ul\",true],[10,\"class\",\"list\"],[8],[0,\"\\n\"],[4,\"each\",[[24,[\"model\"]]],null,{\"statements\":[[0,\"    \"],[7,\"li\",true],[8],[0,\"\\n      \"],[1,[23,1,[\"name\"]],false],[0,\"\\n    \"],[9],[0,\"\\n\"]],\"parameters\":[1]},null],[9],[0,\"\\n\"]],\"hasEval\":false}",
    "meta": {
...
;define("shop/tests/mirage/mirage.lint-test", [], function () {
  ...
  QUnit.test('mirage/config.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'mirage/config.js should pass ESLint\n\n2:31 - \'request\' is defined but never used. (no-unused-vars)');
  });
